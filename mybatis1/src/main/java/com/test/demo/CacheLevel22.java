...
import com.test.mybatis.mapper.TeacherMapper;
    ...
    public static void main(String[] args) {
       // SqlSession session=null;
        try {
            ...
            Teacher user= mapper.selectByPrimaryKey("1");
            ...
            Teacher u2= new Teacher();u2.setId("2");u2.setSex(user.getSex());
